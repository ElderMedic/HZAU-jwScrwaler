# _*_ coder:Changlin Ke _*_
# _*_ coding=utf-8 _*_
#_*_
#_*_ data crawling from jw.hzau.edu.cn  using the basic modules of python _*_
...
from HTMLparser import  getClassScheduleFromHtml, getStudentInfor, get__VIEWSTATE, getGrade
from peeweeFormModel import Student, db, ClassSchedule, Class, YearGrade, OneLessonGrade, TermGrade
from bs4 import BeautifulSoup

class HZAUjwSpider:

    def __init__(self,student,baseUrl="http://jw.hzau.edu.cn/default5.aspx"):
        reload(sys)
    ...
    def getStudentBaseInfo(self):
        ...
        url = self.baseUrl+"/xsgrxx.aspx?xh="+self.student.studentnumber+"&xm=%BF%C2%B3%A4%C1%D8&gnmkdm=N121501"
...
if __name__ == "__main__":
    ...
    mima = raw_input("请输入密码:")
    try:
        student = Student.get(Student.studentnumber == xuehao)
    except Exception ,e:
        student = Student(studentnumber= xuehao, password=mima)
        student.save()

    spider = HZAUjwSpider(student,baseUrl="http://jw.hzau.edu.cn") # 实例化爬虫
    spider.login()
